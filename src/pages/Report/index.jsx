...
// import { PDFDownloadLink, PDFViewer } from '@react-pdf/renderer';
// import PDFReport from './PdfReport';
// import PDFDataForm from './PdfDataForm'; // Import komponen form baru
// import { saveAs } from 'file-saver';
// import { pdf } from '@react-pdf/renderer';
...
//         rekapPengunjung,
//         rekapPenitipan,
//         pdfFormData: formData // Tambahkan data form ke PDF
//       };
...
//   // Fungsi untuk menampilkan form sebelum preview
//   const onPreviewClick = () => {
//     setActionType('preview');
//     setShowPdfForm(true);
//   };

//   // Fungsi untuk menampilkan form sebelum export
//   const onExportClick = () => {
...
const Report = () => {
  ...
  const filteredPengunjungs = pengunjungs.filter((pengunjung) => {
    ...
    const pengunjungDate = new Date(pengunjung.createdAt).setHours(0, 0, 0, 0); // Normalisasi ke tengah malam
