...
//   // Fungsi untuk mengecek apakah form memiliki data yang akan disimpan
//   const hasFormData = () => {
//     return (
//       formData.jenis_barang.trim() !== "" ||
...
//     // Cek apakah form memiliki data yang akan disimpan
//     if (hasFormData()) {
//       // Jika ada data, tampilkan konfirmasi dan simpan terlebih dahulu
//       const confirmSave = window.confirm(
//         "Form masih memiliki data yang belum disimpan. Apakah Anda ingin menyimpan data terlebih dahulu sebelum menutup?"
//       );
      
//       if (confirmSave) {
//         // Buat event synthetic untuk handleSubmit
//         const syntheticEvent = { preventDefault: () => {} };
//         const success = await handleSubmit(syntheticEvent);
        
//         if (success) {
//           // Jika berhasil disimpan, tutup modal
//           resetFormAndClose();
//         }
//         // Jika gagal, biarkan modal terbuka (error sudah ditampilkan)
//       } else {
//         // Jika user memilih untuk tidak menyimpan, langsung tutup
//         resetFormAndClose();
//       }
//     } else {
//       // Jika tidak ada data, langsung tutup
//       resetFormAndClose();
//     }
//   };
...
//         "Form masih memiliki data yang belum disimpan. Apakah Anda yakin ingin menutup tanpa menyimpan?"
//       );
...
// Komponen Floating Keyboard Toggle Button
const FloatingKeyboardToggle = ({ isKeyboardEnabled, onToggleKeyboard }) => {
  return (
    <button
...
const CreateBarangTitipanModal = ({ isOpen, onClose, pengunjungs }) => {
  ...
  useEffect(() => {
    const savedKeyboardPreference = localStorage.getItem('virtualKeyboardEnabledBarang');
  ...
  const toggleKeyboard = () => {
    ...
    localStorage.setItem('virtualKeyboardEnabledBarang', JSON.stringify(newState));
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  onFocus={() => {
                    if (isKeyboardEnabled) {
                      handleInputFocus('jumlah', formData.jumlah);
                    }
                  }}
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                  placeholder="Masukkan Jumlah Barang"
              ...
              <p className="text-xs text-gray-500 mt-1">
                Jumlah harus lebih dari 0 • {isKeyboardEnabled ? 'Gunakan keyboard virtual untuk tombol 00/000 • ' : ''}Gunakan voice-to-text untuk input suara
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <textarea
                  ...
                  onFocus={() => {
                    if (isKeyboardEnabled) {
                      handleInputFocus('keterangan', formData.keterangan);
                    }
                  }}
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                  placeholder="Masukkan keterangan tambahan tentang barang titipan..."
