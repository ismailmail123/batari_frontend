    ...
    try {
      ...
      if (updatedPengunjung) {
        ...
        setTimeout(() => {
          ...
          setAntrian(null);
          fetchPengunjung(); // Refresh data
          // PERUBAHAN: Navigate berdasarkan tujuan pengunjung
        if (selectedPengunjung.tujuan === "Berkunjung") {
          navigate(`/pengunjung/${selectedPengunjung.kode}`);
        } else if (selectedPengunjung.tujuan === "Menitip barang") {
          navigate(`/label/${selectedPengunjung.kode}`);
        } else {
          // Default fallback
          navigate(`/pengunjung/${selectedPengunjung.kode}`);
        }
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200">
                    ...
                    {selectedPengunjungKartu && (
                      <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                        ...
                        <button
                          onClick={() => navigate(`/pengunjung/${selectedPengunjungKartu.kode}`)}
