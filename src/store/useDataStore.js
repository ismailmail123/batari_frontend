...
const useDataStore = create((set, get) => ({
    ...
    login: async(credentials, navigate, setError) => {
        try {
            const response = await axios.post("https://batarirtnbantaeng.cloud/api/auth/login", credentials);
    ...
    fetchUserData: async() => {
        try {
            ...
            const response = await axios.get("https://batarirtnbantaeng.cloud/api/user", {
                headers: {
