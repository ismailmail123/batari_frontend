    ...
    persist(
        (set, get) => ({
            ...
            signup: async(data) => {
                ...
                try {
                    const res = await axios.post("https://api-invitation.xyz/api/auth/register", data);
            ...
            verify: async(data) => {
                set({ isSigningUp: true });
                try {
                    const res = await axios.post("https://api-invitation.xyz/api/auth/verify-email", data);
                    set({ authUser: res.data });
                    localStorage.setItem("authUser", JSON.stringify(res.data)); // Simpan data user di local storage
                } catch (error) {
            ...
            login: async(data) => {
                ...
                try {
                    const res = await axios.post("https://api-invitation.xyz/api/auth/login", data);
            ...
            logout: async() => {
                try {
                    await axios.post("https://api-invitation.xyz/api/auth/logout"); // Panggil API logout
            ...
            updateProfile: async(data) => {
                ...
                try {
                    const res = await axios.put("https://api-invitation.xyz/api/auth/update-profile", data);
                    set({ authUser: res.data });
                    localStorage.setItem("authUser", JSON.stringify(res.data)); // Simpan data user di local storage
